...
| Ресурс логически удален | `410 Gone` | Если soft delete включен |
...
| API-DEL-06 | High | БД недоступна во время удаления | `503 Service Unavailable`, состояние не считается измененным |
